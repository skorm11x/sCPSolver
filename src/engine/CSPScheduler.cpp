...
json CSPScheduler::solve(const json& problem) {
    ...
    map_problem(problem, model_builder, var_map);
...
//return the loaded CpModelBuilder and the unordered_map<string, IntVar> var_map;
CSPScheduler::map_problem(const json& problem, const CpModelBuilder& model_builder, const unordered_map& var_map) {
